...
export const metadata: Metadata = {
  title: 'Sahara Speedster - Fast-Paced Arabic Mythology Platformer',
  description: 'Unleash your magic in Sahara Speedster! Experience thrilling platforming with Arabic characters and mythology-based magic. Wishlist now!',
  keywords: ['game', 'platformer', 'arabic', 'mythology', 'magic', 'speedster', 'sahara'],
  generator: 'v0.app',
  icons: {
    icon: [
      {
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <script>
(function(){
  var TOKEN="f656ef35-a970-40c8-8dd8-a6f9a66f81fae1a0778a54ba8251c46bec8e34522332";
